  ...
  return (
    <div className="page-enter mx-auto max-w-5xl px-4 sm:px-6 py-16">
      ...
      <div className="mt-8 rounded-3xl border border-gray-200 bg-white p-10 shadow-sm">
        <h1 className="font-display text-4xl font-bold text-charcoal-900">Order status</h1>
        ...
        {validOrder ? (
          <div className="mt-10 grid gap-6 rounded-3xl bg-bloom-50 p-8 text-gray-800">
            <div className="rounded-2xl border border-bloom-100 bg-white p-6 shadow-sm">
          ...
          <div className="mt-10 rounded-2xl border border-red-100 bg-red-50 p-8 text-red-700">
